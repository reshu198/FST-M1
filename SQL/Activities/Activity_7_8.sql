...
SELECT salesman_id,order_date, MAX(purchase_amount) AS MAX_Purchase FROM orders WHERE order_date = TO_DATE('2012/08/17','YYYY/MM/DD') GROUP BY salesman_id;
...
SELECT salesman_id, MAX(purchase_amount) AS MAX_Purchase FROM orders 
WHERE order_date=TO_DATE('2012/08/17', 'YYYY/MM/DD') GROUP BY salesman_id;
