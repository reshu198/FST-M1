...
with webdriver.Firefox() as driver:
    ...
    wait.until(E.element_to_be_clickable((By.XPATH, "//button[text()='Open A New Tab']"))).click()
    # Wait for the second tab to open
    wait.until(E.number_of_windows_to_be(2))
    # Print all window handles
    print("Currently open windows: ", driver.window_handles)
    driver.switch_to.window(driver.window_handles[1])

    # Wait for the new page to load
    wait.until(E.element_to_be_clickable((By.XPATH, "//button[contains(text(), 'Another One')]")))
    ...
    wait.until(E.number_of_windows_to_be(3))
    # Switch focus
